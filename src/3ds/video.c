...
void N3DS_InitTexture(void)
{
	if (texInitialized == 0)
	{
		...
		tex = sf2d_create_texture(512, Screen_HEIGHT, TEXFMT_RGBA8, SF2D_PLACE_RAM);
		texBuf = linearAlloc((512 * Screen_HEIGHT) << 2);
...
void PLATFORM_DisplayScreen(void)
{
	...
	tex->tiled = 0;
	sf2d_texture_tile32_hardware(tex, texBuf, 512, Screen_HEIGHT);
